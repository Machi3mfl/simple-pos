...
11. Feature set:
   ...
   - [POS-002](./features/POS-002-cash-register-sessions-and-actor-audit-planning.md)
     ...
     - [POS-002 Identity Bootstrap Sequence](./planning/diagrams/sequence-identity-and-permission-bootstrap.md)
   ...
   - [TRAINING-001](./features/TRAINING-001-playwright-tutorial-video-suite-planning.md)
...
| Post-MVP operations controls batch | Cash register sessions, cash reconciliation, actor attribution, role-based UI/data protection foundation, delivered Slice 0/1 workflow checkpoints, and operator tutorial recordings | [POS-002](./features/POS-002-cash-register-sessions-and-actor-audit-planning.md), [TRAINING-001](./features/TRAINING-001-playwright-tutorial-video-suite-planning.md) |
...
| `NFR Evidence` | Verification evidence and command trace for non-functional requirements closure | [008 NFR Validation Evidence](./planning/008-nfr-validation-evidence-ready.md) |
